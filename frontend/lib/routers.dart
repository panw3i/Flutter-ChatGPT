...
import 'package:frontend/pages/document/doc_page.dart';
import 'package:frontend/pages/task/task_page.dart';
import 'package:frontend/pages/translate/translate_page.dart';
import 'package:frontend/pages/write/write_page.dart';
...
final menuNameList = [
  t.chat.menuName,
  t.translate.menuName,
  t.write.menuName,
  t.document.menuName,
  t.task.menuName
];
final menuRouterList = ['/chat', '/translate', '/write', '/document', '/task'];
